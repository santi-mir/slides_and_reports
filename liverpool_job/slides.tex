...
\begin{figure}
    \begin{subfigure}[b]{0.45\textwidth}
      \includegraphics[width=0.9\textwidth]{./jpeg/CVAE.jpeg}
    ...
    \pause
    \begin{subfigure}[b]{0.45\textwidth}
      \includegraphics[trim=0 0 35cm 0, width=0.68\textwidth]{./png/interpretability.png}
      \caption{Transformer Orion Dollar et. al.}
