...
% Downloads
\NewDocumentCommand{\downloadsize}{}{5em}
...
\begin{frame}{Previous Work}
  ...
  \item \color<6->{gray} Binary parsers for chemical data,
...
Questions used to frame the project:

\vspace{1em}
\begin{itemize}
  \item What is the end-goal?
  \item Can it be split into subgoals?
  \item Estimated time to completion?
  \item Are there alternative ways to solve the problem?
\end{itemize}
...
\begin{tabular}{lcp{3.5cm}}
  \github{} Github Project & \npm{} npm / month & Description \\[0.3em]
  \hline
  \noalign{\vskip 0.5em}
