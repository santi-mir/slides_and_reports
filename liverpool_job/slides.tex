...
\begin{frame}{Areas of experience}
  ...
  \item \xp{Research}
    ...
    \item Molecular inverse design with VAEs.
    \end{itemize}
    \pause
  \item \xp{Applied ML}
    \begin{itemize}
      \setlength\itemsep{0.3em}
    \item Object detection systems (YOLOX).
    \end{itemize}
    \pause
  \item \xp{Scientific Computing}
    \begin{itemize}
      \setlength\itemsep{0.3em}
      \item Mathematical optimisation algorithms
      \item Binary parsers for spectroscopy data
    \end{itemize}
  \end{itemize}
\end{frame}
